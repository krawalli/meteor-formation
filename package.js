...
Package.onUse( function( api ) {
  ...
  api.use([ 'quietcreep:formation-core@1.0.0', 'quietcreep:formation-blaze-widgets@1.0.1' ]);
  api.imply([ 'quietcreep:formation-core@1.0.0', 'quietcreep:formation-blaze-widgets@1.0.1' ]);
});
