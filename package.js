...
Package.onUse( function( api ) {
  ...
  api.use([ 'quietcreep:formation-core@1.0.3_3', 'quietcreep:formation-blaze-widgets@1.0.3' ]);
  api.imply([ 'quietcreep:formation-core@1.0.3_3', 'quietcreep:formation-blaze-widgets@1.0.3' ]);
});
