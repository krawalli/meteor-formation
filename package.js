...
Package.onUse( function( api ) {
  ...
  api.use([ 'quietcreep:formation-core@1.0.5', 'quietcreep:formation-blaze-widgets@1.0.4' ]);
  api.imply([ 'quietcreep:formation-core@1.0.5', 'quietcreep:formation-blaze-widgets@1.0.4' ]);
});
