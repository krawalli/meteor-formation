...
Package.onUse( function( api ) {
  ...
  api.use([ 'quietcreep:formation-core@1.0.4', 'quietcreep:formation-blaze-widgets@1.0.3_5' ]);
  api.imply([ 'quietcreep:formation-core@1.0.4', 'quietcreep:formation-blaze-widgets@1.0.3_5' ]);
});
